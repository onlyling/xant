 ...
 */
const Divider: React.FC<DividerProps> = ({ children, textStyle, borderStyle, style, dashed = false, hairline = true, contentPosition = 'center' }) => {
  ...
  const leftBorderStyleSummary: ViewStyle = StyleSheet.flatten([Styles.border, Styles.borderLeft, borderStyle]);
  const rightBorderStyleSummary: ViewStyle = StyleSheet.flatten([Styles.border, Styles.borderRight, borderStyle]);
