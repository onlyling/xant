...
import { Progress, ProgressPage, Button } from 'xant';
    ...
    <ProgressPage loading={state.loading}>
      <ScrollView>
        <View style={{ paddingHorizontal: 30 }}>
          ...
          <Progress percentage={40} color="#f30" strokeWidth={10} trackColor="#ddd" textColor="#000" />
          ...
          <Progress percentage={40} color="#f30" strokeWidth={10} trackColor="#ddd" textColor="#000" inactive />
        </View>
      </ScrollView>
    </ProgressPage>
  );
