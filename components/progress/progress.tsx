...
const Progress: React.FC<ProgressProps> = ({
  ...
  animationDuration = getDefaultValue(animationDuration, themeVar.animation_duration_base);
  ...
  const progressStyle: ViewStyle = { position: 'relative', height: strokeWidth, backgroundColor: trackColor, borderRadius: borderRadius };
