...
export const createStyles = (themeVar: ThemeVarType) => {
  ...
  return StyleSheet.create({
    ...
    clearableWrapper: {
      // backgroundColor: '#f30',
      paddingHorizontal: (themeVar.text_input_min_height - themeVar.text_input_clearable_size) / 4,
      paddingVertical: (themeVar.text_input_min_height - themeVar.text_input_clearable_size) / 4,
      zIndex: 3,
    },
