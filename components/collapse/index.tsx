import React, { useRef, useEffect, useCallback, useState, memo, isValidElement } from 'react';
...
const Collapse: React.FC<CollapseProps> = ({ children, title, renderTitle, renderBody, defaultCollapse, collapse, onAnimationEnd }) => {
  ...
  const Visible = useRef(isDef(collapse) ? collapse : isDef(defaultCollapse) ? defaultCollapse : false);
  ...
  const setVisible = useCallback(
    ...
    [AnimatedValue, onAnimationEndPersistFn, themeVar.collapse_transition_duration],
  );
