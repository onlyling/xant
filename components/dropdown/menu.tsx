...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  const config = useMemo(
    () => ({
      top,
      activeColor: activeColor || themeVar.dropdown_menu_title_active_text_color,
      direction,
      zIndex,
      duration,
      overlay,
    ...
    [themeVar.dropdown_menu_title_active_text_color, top, activeColor, direction, zIndex, duration, overlay, closeOnPressOverlay, closeOnPressOutside],
  );
