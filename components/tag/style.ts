...
export const createStyles = (
  ...
  const paddingHorizontal = themeVar[`tag_${size}_padding_horizontal` as 'tag_horizontal_padding'] || themeVar.tag_padding_horizontal;
  const paddingVertical = themeVar[`tag_${size}_padding_vertical` as 'tag_medium_padding_vertical'] || 0;
