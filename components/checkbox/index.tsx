...
const Checkbox: React.FC<CheckboxProps> = ({
  ...
  const labelStyleSummary = StyleSheet.flatten([
    Styles.label,
    {
      [labelPosition === 'left' ? 'marginRight' : 'marginLeft']: themeVar.checkbox_label_margin,
    },
  ...
  const labelJSX = isDef(label) ? (
    <Text style={labelStyleSummary} onPress={labelDisabled ? undefined : onChangeValue}>
      {label}
    </Text>
  ) : (
    children
  ...
  return (
    <View style={checkboxStyleSummary}>
      ...
      <CheckboxIcon active={currentValue} activeColor={activeColor} shape={shape} disabled={disabled} size={iconSize} onPress={onChangeValue} />
